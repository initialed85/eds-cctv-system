...
func getEventStoreAndLastTimeAndNow() (event_store.Store, time.Time, time.Time) {
	...
	event2 := event_store.NewEvent(time1, "camera2", "image2-hi", "image2-lo", "video2-hi", "video2-lo")
	event3 := event_store.NewEvent(time2, "camera3", "image3-hi", "image3-lo", "video3-hi", "video3-lo")
